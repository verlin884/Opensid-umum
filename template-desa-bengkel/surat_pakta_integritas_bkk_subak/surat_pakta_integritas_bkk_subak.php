				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action ?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="alamat" class="col-sm-3 control-label">Alamat Penandatangan: </label>
								<div class="col-sm-3">
									<input type="text" id="alamat" class="form-control input-sm required" placeholder="Alamat Penandatangan" name="alamat" value="Br. Bengkel Gede, Desa Bengkel, Kec. Kediri, Kab. Tabanan" />
								</div>
							</div>

							<div class="form-group">
								<label for="tenggal" class="col-sm-3 control-label">Tenggat Administrasi: </label>
								<div class="col-sm-3">
									<input type="text" id="tenggat" class="form-control input-sm required" placeholder="Tenggat Administrasi" name="tenggat" value="akhir bulan Desember tahun 2023" />
								</div>
							</div>
