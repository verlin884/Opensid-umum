...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Permohonan Bagi Hasil Retribusi</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Permohonan Pencairan Bagi Hasil Retribusi</li>
		</ol>
	</section>
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="bulan"  class="col-sm-3 control-label">Triwulan</label>
								<div class="col-sm-8">
									<select class="form-control required input-sm select2" id="bulan" name="bulan" style ="width:100%;" >
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input name="nomor_penetapan_perdes" class="form-control input-sm required" placeholder="06 Tahun 2019" value="06 Tahun 2019" />
								</div>
							</div>
