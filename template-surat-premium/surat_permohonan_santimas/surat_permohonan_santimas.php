...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Permohonan SANTIMAS</h1>
		<ol class="breadcrumb tdk-permohonan tdk-periksa">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Permohonan SANTIMAS</li>
		</ol>
	</section>
				...
				<div class="box box-info">
					...
					<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-6 col-lg-4">
									<select class="form-control required input-sm select2" id="nik" name="nik" style ="width:100%;" onchange="formAction('main')">
										<option value="">--  Cari NIK / Nama Penduduk Yang Mati --</option>
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="nama_ahli_waris"  class="col-sm-3 control-label">Nama Ahli Waris</label>
								<div class="col-sm-4">
									<input  id="nama_ahli_waris" class="form-control input-sm required" placeholder="Nama Ahli Waris" name="nama_ahli_waris" />
								</div>
							</div>
