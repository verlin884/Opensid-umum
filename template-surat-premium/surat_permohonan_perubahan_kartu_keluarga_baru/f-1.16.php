...
<page orientation="portrait" format="210x330" style="font-size: 8pt">
	...
	<table class="disdukcapil" style="margin-top: 0px;">
		...
		<tr><td colspan="48">&nbsp;</td></tr>
		<tr>
			<td colspan="24" style="text-align: center;">Mengetahui</td>
			<td colspan="24" style="text-align: center;">Pemohon</td>
		</tr>
		<tr><td colspan="48">&nbsp;</td></tr>
		<tr>
			<td colspan="24" style="text-align: center;"><?= $this->penandatangan_lampiran($data);?></td>
			<td colspan="24">&nbsp;</td>
		</tr>
		<tr><td colspan="48">&nbsp;</td></tr>
		<tr><td colspan="48">&nbsp;</td></tr>
		<tr>
			<td colspan="24" style="text-align: center;"><strong>(<?= padded_string_center(strtoupper($kepala_desa['pamong_nama']),30)?>)</strong></td>
			<td colspan="24" style="text-align: center;"><strong>(<?= padded_string_center(strtoupper($individu['nama']),30)?>)</strong></td>
		</tr>
		<tr>
			<td colspan="24" style="text-align: center;"><?= "NIP&nbsp;&nbsp;:&nbsp;".$kepala_desa['pamong_nip']?></td>
			<td colspan="24">&nbsp;</td>
		</tr>
		<tr><td colspan="48">&nbsp;</td></tr>
		<tr><td colspan="48">&nbsp;</td></tr>
