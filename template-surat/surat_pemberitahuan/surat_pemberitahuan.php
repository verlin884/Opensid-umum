...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Himbauan / Pemberitahuan / Larangan</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Himbauan / Pemberitahuan / Larangan</li>
		</ol>
	</section>
				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="paragraf_3"  class="col-sm-3 control-label">Paragraf Ketiga</label>
								<div class="col-sm-8">
									<textarea  id="paragraf_3" class="form-control input-sm required" placeholder="Kehadiran saudara dalam acara rapat koordinasi tersebut akan sangat menentukan kesuksesan acara Peringatan Hari Kesaktian Pancasila tersebut." name="paragraf_3"></textarea>
								</div>
							</div>

							<div class="form-group">
								<label for="nama_mengetahui"  class="col-sm-3 control-label">Nama Yang Mengetahui</label>
								<div class="col-sm-8">
									<input type="text" name="nama_mengetahui" class="form-control input-sm " placeholder="Nama Yang Mengetahui" />
								</div>
							</div>

							<div class="form-group">
								<label for="jabatan_mengetahui"  class="col-sm-3 control-label">Jabatan Yang Mengetahui</label>
								<div class="col-sm-8">
									<input type="text" name="jabatan_mengetahui" class="form-control input-sm " placeholder="Jabatan Yang Mengetahui" />
								</div>
							</div>
