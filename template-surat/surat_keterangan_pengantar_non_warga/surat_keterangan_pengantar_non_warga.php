<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Keterangan Pengantar Non Warga</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Keterangan Pengantar Non Warga</li>
		</ol>
	</section>
			...
			<div class="col-md-12">
                ...
                <div class="col-sm-4">
                  <select class="form-control input-sm" name="pekerjaan" id="pekerjaan">
							...
							<div class="form-group">
								<label for="bangunan"  class="col-sm-3 control-label">Peruntukan </label>
								<div class="col-sm-3">
									<input id="bangunan" class="form-control input-sm required" type="text" placeholder="Peruntukan" name="peruntukan">
								</div>
								
								
							</div>
							<div class="form-group">
								<label for="alamat_usaha"  class="col-sm-3 control-label">Keterangan</label>
								<div class="col-sm-8">
