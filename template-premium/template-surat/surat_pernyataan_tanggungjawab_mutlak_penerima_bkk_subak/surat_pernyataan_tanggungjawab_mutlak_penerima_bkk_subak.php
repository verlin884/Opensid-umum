					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea  id="keterangan" class="form-control input-sm required" placeholder="Belanja Bantuan Keuangan Khusus (BKK) Subak" name="keterangan">Belanja Bantuan Keuangan Khusus (BKK) Subak</textarea>
								</div>
							</div>
