									...
									<div class="col-md-12">
										...
										<div class="form-group subtitle_head">
											...
											<div class="btn-group col-sm-8" data-toggle="buttons">
												<label id="pemohon_11" class="btn btn-info btn-flat btn-sm col-sm-4 col-sm-4 col-md-4 col-lg-3 form-check-label <?php if (!empty($individu)) : ?>active<?php endif ?>">
												...
												<label id="pemohon_22" class="btn btn-info btn-flat btn-sm col-sm-4 col-md-4 col-lg-3 form-check-label <?php if (empty($individu)) : ?>active<?php endif; ?>">
