				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="lokasi_tanah"  class="col-sm-3 control-label">Lokasi Tanah</label>
								<div class="col-sm-8">
									<textarea name="lokasi_tanah" class="form-control input-sm required" placeholder="Lokasi Tanah"></textarea>
								</div>
							</div>
							<div class="form-group">
								<label for="keperluan"  class="col-sm-3 control-label">Keperluan</label>
								<div class="col-sm-8">
									<textarea  id="keperluan" class="form-control input-sm required" placeholder="Keperluan" name="keperluan"></textarea>
								</div>
							</div>
							<div class="form-group">
