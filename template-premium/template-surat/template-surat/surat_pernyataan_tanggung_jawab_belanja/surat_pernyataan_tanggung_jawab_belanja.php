				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="nomor_dpa"  class="col-sm-3 control-label">Nomor DPA</label>
								<div class="col-sm-8">
									<input type="text" name="nomor_dpa" class="form-control input-sm required" placeholder="Nomor DPA" />
								</div>
							</div>

							<div class="form-group">
								<label for="tgl_dpa"  class="col-sm-3 control-label">Tanggal DPA</label>
								<div class="col-sm-3 col-lg-2">
									<div class="input-group input-group-sm date">
										<div class="input-group-addon">
											<i class="fa fa-calendar"></i>
										</div>
										<input title="Pilih Tanggal" id="tgl_2" class="form-control input-sm required" name="tanggal_dpa" type="text"  />
									</div>
								</div>
							</div>
