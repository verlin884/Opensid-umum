...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Pernyataan Keberadaan Subak Di Wilayah Desa</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Pernyataan Keberadaan Subak Di Wilayah Desa</li>
		</ol>
	</section>
				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								<label for="keterangan"  class="col-sm-3 control-label">Nama-nama Subak</label>
								<div class="col-sm-8">
									<textarea  id="keterangan" class="form-control input-sm required" placeholder="Nama-nama Subak" name="keterangan"></textarea>
								</div>
							</div>
