...
<div class="content-wrapper">
	<section class="content-header">
		<h1>Surat Pencairan BKK</h1>
		<ol class="breadcrumb">
			<li><a href="<?= site_url('hom_desa/about')?>"><i class="fa fa-dashboard"></i> Home</a></li>
			<li><a href="<?= site_url('surat')?>"> Daftar Cetak Surat</a></li>
			<li class="active">Surat Pencairan BKK</li>
		</ol>
	</section>
					...
					<div class="box-body">
						...
						<form id="validasi" action="<?= $form_action?>" method="POST" target="_blank" class="form-surat form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea name="keperluan" class="form-control input-sm required" placeholder="Laporan Pertanggungjawaban Belanja Bantuan Keuangan Khusus (BKK) kepada Kabupaten / Kota">Laporan Pertanggungjawaban Belanja Bantuan Keuangan Khusus (BKK) kepada Kabupaten / Kota
								   </textarea>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea  id="keterangan" class="form-control input-sm required" placeholder="Pertanggungjawaban BKK Subak" name="keterangan">Laporan Pertanggungjawaban Belanja Bantuan Keuangan Khusus (BKK) kepada Kabupaten / Kota</textarea>
								</div>
							</div>
